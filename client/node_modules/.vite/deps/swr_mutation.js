...
var useStateWithDeps = (initialState) => {
  const [, rerender] = (0, import_react4.useState)({});
  const unmountedRef = (0, import_react4.useRef)(false);
  const stateRef = (0, import_react4.useRef)(initialState);
  const stateDependenciesRef = (0, import_react4.useRef)({
    data: false,
    error: false,
    isValidating: false
  });
  const setState = (0, import_react4.useCallback)((payload) => {
...
var mutation = () => (key, fetcher, config = {}) => {
  ...
  const fetcherRef = (0, import_react4.useRef)(fetcher);
  const configRef = (0, import_react4.useRef)(config);
  const ditchMutationsUntilRef = (0, import_react4.useRef)(0);
